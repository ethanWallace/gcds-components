...
var import_gcds_hint = require("./components/gcds-hint.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-hint")) {
  (0, import_gcds_hint.defineCustomElement)();
}
const customEvents = [];
const GcdsHint = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-hint", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-hint", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-hint", { ...nativeProps, ref }, children);
});
