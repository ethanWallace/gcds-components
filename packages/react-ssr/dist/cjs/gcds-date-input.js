...
__export(gcds_date_input_exports, {
  GcdsDateInput: () => GcdsDateInput
});
module.exports = __toCommonJS(gcds_date_input_exports);
var import_react = __toESM(require("react"));
var import_gcds_date_input = require("./components/gcds-date-input.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-date-input")) {
  (0, import_gcds_date_input.defineCustomElement)();
}
const customEvents = ["gcdsFocus", "gcdsBlur", "gcdsInput", "gcdsChange", "gcdsError", "gcdsValid"];
const GcdsDateInput = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-date-input", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-date-input", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-date-input", { ...nativeProps, ref }, children);
});
