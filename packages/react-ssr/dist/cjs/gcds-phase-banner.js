...
__export(gcds_phase_banner_exports, {
  GcdsPhaseBanner: () => GcdsPhaseBanner
});
module.exports = __toCommonJS(gcds_phase_banner_exports);
var import_react = __toESM(require("react"));
var import_gcds_phase_banner = require("./components/gcds-phase-banner.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-phase-banner")) {
  (0, import_gcds_phase_banner.defineCustomElement)();
}
const customEvents = [];
const GcdsPhaseBanner = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-phase-banner", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-phase-banner", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-phase-banner", { ...nativeProps, ref }, children);
});
