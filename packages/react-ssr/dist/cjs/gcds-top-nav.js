...
__export(gcds_top_nav_exports, {
  GcdsTopNav: () => GcdsTopNav
});
module.exports = __toCommonJS(gcds_top_nav_exports);
var import_react = __toESM(require("react"));
var import_gcds_top_nav = require("./components/gcds-top-nav.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-top-nav")) {
  (0, import_gcds_top_nav.defineCustomElement)();
}
const customEvents = [];
const GcdsTopNav = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-top-nav", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-top-nav", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-top-nav", { ...nativeProps, ref }, children);
});
