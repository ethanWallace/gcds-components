...
__export(gcds_radio_group_exports, {
  GcdsRadioGroup: () => GcdsRadioGroup
});
module.exports = __toCommonJS(gcds_radio_group_exports);
var import_react = __toESM(require("react"));
var import_gcds_radio_group = require("./components/gcds-radio-group.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-radio-group")) {
  (0, import_gcds_radio_group.defineCustomElement)();
}
const customEvents = ["gcdsChange", "gcdsFocus", "gcdsBlur"];
const GcdsRadioGroup = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-radio-group", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-radio-group", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-radio-group", { ...nativeProps, ref }, children);
});
