...
var import_gcds_alert = require("./components/gcds-alert.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-alert")) {
  (0, import_gcds_alert.defineCustomElement)();
}
const customEvents = ["gcdsDismiss"];
const GcdsAlert = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-alert", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-alert", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-alert", { ...nativeProps, ref }, children);
});
