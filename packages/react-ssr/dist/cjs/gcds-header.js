...
var import_gcds_header = require("./components/gcds-header.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-header")) {
  (0, import_gcds_header.defineCustomElement)();
}
const customEvents = [];
const GcdsHeader = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-header", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-header", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-header", { ...nativeProps, ref }, children);
});
