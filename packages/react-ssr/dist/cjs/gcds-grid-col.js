...
var import_gcds_grid_col = require("./components/gcds-grid-col.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-grid-col")) {
  (0, import_gcds_grid_col.defineCustomElement)();
}
const customEvents = [];
const GcdsGridCol = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-grid-col", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-grid-col", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-grid-col", { ...nativeProps, ref }, children);
});
