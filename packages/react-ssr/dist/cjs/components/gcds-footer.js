...
var gcds_footer_exports = {};
__export(gcds_footer_exports, {
  GcdsFooter: () => GcdsFooter2,
  defineCustomElement: () => defineCustomElement
});
module.exports = __toCommonJS(gcds_footer_exports);
  ...
  fr: {
    ...
    themes: {
      ...
      menu: {
        ...
        immigration: {
          text: "Immigration et citoyennet\xE9",
        ...
        defence: {
          text: "S\xE9curit\xE9 nationale et d\xE9fense",
        ...
        veterans: {
          text: "V\xE9t\xE9rans et militaires",
...
const GcdsFooter$1 = /* @__PURE__ */ (0, import_stencil.proxyCustomElement)(class GcdsFooter extends import_stencil.HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.display = "compact";
    this.wordmarkVariant = void 0;
    this.contextualHeading = void 0;
    this.contextualLinks = void 0;
    this.subLinks = void 0;
    this.lang = void 0;
  }
  /**
  ...
  get renderSignature() {
    ...
    if (this.el.querySelector('[slot="signature"]')) {
      return (0, import_stencil.h)("slot", { name: "wordmark" });
    } else {
      return (0, import_stencil.h)("div", { class: "sub__wordmark" }, (0, import_stencil.h)("gcds-signature", { type: "wordmark", variant: signVariant, lang: this.lang }));
    }
  }
  render() {
    ...
    let subLinkCount = 0;
    return (0, import_stencil.h)(import_stencil.Host, { role: "contentinfo", "aria-label": "Footer" }, (0, import_stencil.h)("gcds-sr-only", { tag: "h2" }, I18N[lang].about), contextualLinksObject && contextualHeading && (0, import_stencil.h)("div", { class: "gcds-footer__contextual" }, (0, import_stencil.h)("div", { class: "contextual__container" }, (0, import_stencil.h)("nav", { "aria-labelledby": "contextual__heading" }, (0, import_stencil.h)("h3", { id: "contextual__heading", class: "contextual__heading" }, contextualHeading), (0, import_stencil.h)("ul", { class: "contextual__list" }, Object.keys(contextualLinksObject).map((key) => {
      if (contextualLinkCount < 3) {
        contextualLinkCount++;
        return (0, import_stencil.h)("li", null, (0, import_stencil.h)("gcds-link", { size: "small", href: contextualLinksObject[key] }, key));
      }
    }))))), display === "full" ? (0, import_stencil.h)("div", { class: "gcds-footer__main" }, (0, import_stencil.h)("div", { class: "main__container" }, (0, import_stencil.h)("nav", { class: "main__govnav", "aria-labelledby": "govnav__heading" }, (0, import_stencil.h)("h3", { id: "govnav__heading" }, I18N[lang].gov.heading), (0, import_stencil.h)("ul", { class: "govnav__list" }, Object.keys(govNav).map((value) => (0, import_stencil.h)("li", null, (0, import_stencil.h)("gcds-link", { size: "small", href: govNav[value].link }, govNav[value].text))))), (0, import_stencil.h)("nav", { class: "main__themenav", "aria-labelledby": "themenav__heading" }, (0, import_stencil.h)("gcds-sr-only", { tag: "h4", id: "themenav__heading" }, I18N[lang].themes.heading), (0, import_stencil.h)("ul", { class: "themenav__list" }, Object.keys(themeNav).map((value) => (0, import_stencil.h)("li", null, (0, import_stencil.h)("gcds-link", { size: "small", href: themeNav[value].link }, themeNav[value].text))))))) : null, (0, import_stencil.h)("div", { class: "gcds-footer__sub" }, (0, import_stencil.h)("div", { class: "sub__container" }, (0, import_stencil.h)("nav", { "aria-labelledby": "sub__heading" }, (0, import_stencil.h)("gcds-sr-only", { tag: "h3", id: "sub__heading" }, I18N[lang].site.heading), (0, import_stencil.h)("ul", null, subLinks ? Object.keys(subLinksObject).map((key) => {
      if (subLinkCount < 5) {
        subLinkCount++;
        return (0, import_stencil.h)("li", null, (0, import_stencil.h)("gcds-link", { size: "small", href: subLinksObject[key] }, key));
      }
    }) : Object.keys(siteNav).map((value) => {
      return (0, import_stencil.h)("li", null, (0, import_stencil.h)("gcds-link", { size: "small", href: siteNav[value].link }, siteNav[value].text));
    }))), renderSignature)));
  }
  get el() {
    return this;
...
const GcdsFooter2 = GcdsFooter$1;
