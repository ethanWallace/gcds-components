...
var gcds_pagination_exports = {};
__export(gcds_pagination_exports, {
  GcdsPagination: () => GcdsPagination2,
  defineCustomElement: () => defineCustomElement
});
module.exports = __toCommonJS(gcds_pagination_exports);
...
const GcdsPagination$1 = /* @__PURE__ */ (0, import_stencil.proxyCustomElement)(class GcdsPagination extends import_stencil.HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    ...
    this.display = "list";
    this.label = void 0;
    this.previousHref = void 0;
    this.previousLabel = void 0;
    this.nextHref = void 0;
    this.nextLabel = void 0;
  ...
  configurePaginationStep(page, end, mobile) {
    ...
    const linkAttrs = {
      "href": href,
      "aria-label": !end ? I18N[this.lang].pageNumberOf.replace("{#}", page).replace("{total}", this.totalPages).replace("{label}", this.label) : end == "next" ? `${I18N[this.lang].nextPage}: ${I18N[this.lang].pageNumberOf.replace("{#}", ++page).replace("{total}", this.totalPages).replace("{label}", this.label)}` : `${I18N[this.lang].previousPage}: ${I18N[this.lang].pageNumberOf.replace("{#}", --page).replace("{total}", this.totalPages).replace("{label}", this.label)}`,
      "onBlur": () => this.gcdsBlur.emit(),
      "onFocus": () => this.gcdsFocus.emit(),
      "onClick": (e) => (0, import_utils.e)(e, this.gcdsClick, { page, href })
    };
    if (page == this.currentPage && !end) {
      linkAttrs["aria-current"] = "page";
    }
    if (end) {
      return (0, import_stencil.h)("li", null, end === "next" ? (0, import_stencil.h)("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), I18N[this.lang].next, (0, import_stencil.h)("gcds-icon", { "margin-left": "200", name: "arrow-right" })) : (0, import_stencil.h)("a", Object.assign({}, linkAttrs, { class: !mobile ? "gcds-pagination-end-button" : "gcds-pagination-end-button-mobile" }), (0, import_stencil.h)("gcds-icon", { "margin-right": "200", name: "arrow-left" }), mobile ? I18N[this.lang].previousMobile : I18N[this.lang].previous));
    } else {
      return (0, import_stencil.h)("li", { class: page != 1 && page != this.totalPages ? constructClasses(page, this.currentPage, this.totalPages) : "" }, (0, import_stencil.h)("a", Object.assign({}, linkAttrs), page));
    }
  }
  /**
  ...
  configureListPagination() {
    ...
    for (let i = 1; i <= this.totalPages; i++) {
      if (i == 2 && this.currentPage < 6 && this.currentPage > 3 && this.totalPages > 9) {
        this.listitems.push((0, import_stencil.h)("li", { class: `gcds-pagination-list-mobile-ellipses`, "aria-hidden": "true" }, (0, import_stencil.h)("span", { class: "gcds-pagination-list-ellipses" }, "...")));
      ...
      if (i == this.currentPage || i == 1 || i == this.totalPages || i >= this.currentPage - 2 && i <= this.currentPage + 2 || this.totalPages < 10) {
        ...
        this.listitems.push((0, import_stencil.h)("li", { "aria-hidden": "true" }, (0, import_stencil.h)("span", { class: "gcds-pagination-list-ellipses" }, "...")));
  ...
  render() {
    ...
    return (0, import_stencil.h)(import_stencil.Host, { role: "navigation", "aria-label": label }, (0, import_stencil.h)("div", { class: "gcds-pagination" }, display === "list" ? (0, import_stencil.h)("div", null, (0, import_stencil.h)("ul", { class: "gcds-pagination-list" }, this.listitems), (0, import_stencil.h)("ul", { class: "gcds-pagination-list-mobile-prevnext" }, this.mobilePrevNext)) : (0, import_stencil.h)("ul", { class: "gcds-pagination-simple" }, previousHref && (0, import_stencil.h)("li", { class: "gcds-pagination-simple-previous" }, (0, import_stencil.h)("a", { href: previousHref, "aria-label": `${I18N[lang].previousPage}${previousLabel ? `: ${previousLabel}` : ""}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: (e) => (0, import_utils.e)(e, this.gcdsClick, previousHref) }, (0, import_stencil.h)("gcds-icon", { "margin-right": "200", name: "arrow-left" }), (0, import_stencil.h)("div", { class: "gcds-pagination-simple-text" }, I18N[lang].previous), (0, import_stencil.h)("span", null, previousLabel))), nextHref && (0, import_stencil.h)("li", { class: "gcds-pagination-simple-next" }, (0, import_stencil.h)("a", { href: nextHref, "aria-label": `${I18N[lang].nextPage}${nextLabel ? `: ${nextLabel}` : ""}`, onBlur: () => this.gcdsBlur.emit(), onFocus: () => this.gcdsFocus.emit(), onClick: (e) => (0, import_utils.e)(e, this.gcdsClick, nextHref) }, (0, import_stencil.h)("div", { class: "gcds-pagination-simple-text" }, I18N[lang].next), (0, import_stencil.h)("span", null, nextLabel), (0, import_stencil.h)("gcds-icon", { "margin-left": "200", name: "arrow-right" }))))));
  }
  get el() {
    return this;
  }
...
const GcdsPagination2 = GcdsPagination$1;
