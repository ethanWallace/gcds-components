...
var gcds_heading2_exports = {};
__export(gcds_heading2_exports, {
  G: () => GcdsHeading,
  d: () => defineCustomElement
});
module.exports = __toCommonJS(gcds_heading2_exports);
...
const GcdsHeading = /* @__PURE__ */ (0, import_stencil.proxyCustomElement)(class GcdsHeading2 extends import_stencil.HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
