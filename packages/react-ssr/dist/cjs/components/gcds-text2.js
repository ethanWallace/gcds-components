...
var gcds_text2_exports = {};
__export(gcds_text2_exports, {
  G: () => GcdsText,
  d: () => defineCustomElement
});
module.exports = __toCommonJS(gcds_text2_exports);
...
const GcdsText = /* @__PURE__ */ (0, import_stencil.proxyCustomElement)(class GcdsText2 extends import_stencil.HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (0, import_stencil.h)(import_stencil.Host, { class: `${display != "block" ? `d-${display}` : ""}` }, (0, import_stencil.h)("p", { class: `
            gcds-text
            ${textRole ? `role-${textRole}` : ""}
            ${characterLimit ? "limit" : ""}
            ${marginTop ? `mt-${marginTop}` : ""}
            ${marginBottom ? `mb-${marginBottom}` : ""}
          `, part: "text" }, size === "caption" ? (0, import_stencil.h)("small", null, (0, import_stencil.h)("slot", null)) : (0, import_stencil.h)("slot", null)));
  }
  get el() {
    return this;
  }
