...
var gcds_verify_banner_exports = {};
__export(gcds_verify_banner_exports, {
  GcdsVerifyBanner: () => GcdsVerifyBanner2,
  defineCustomElement: () => defineCustomElement
});
module.exports = __toCommonJS(gcds_verify_banner_exports);
var import_stencil = require("../lib/stencil");
var import_utils = require("./utils.js");
var import_gcds_container2 = require("./gcds-container2.js");
var import_gcds_grid2 = require("./gcds-grid2.js");
const I18N = {
  en: {
    summary: {
  ...
  fr: {
    summary: {
      ...
      link: "Comment les reconna\xEEtre"
    },
    content: {
      description: "Il peut \xEAtre difficile de savoir quels sites sont fiables. Avant de partager des renseignements, v\xE9rifiez les points suivant pour d\xE9terminer s'il s'agit bien d'un site du gouvernement du Canada:",
      url: {
      ...
      languages: {
        ...
        text: "V\xE9rifiez que les renseignements sont accessibles en fran\xE7ais et en anglais."
      },
      https: {
        heading: "HTTPS",
        text: "Lorsqu'un navigateur affiche les sites Web s\xE9curitaires du gouvernement du Canada, on retrouve"
      },
      contact: {
        heading: "Un point de communication",
        text: "On retrouve Canada.ca, gc.ca ou le nom du minist\xE8re dans l'URL de toute adresse courriel du gouvernement du Canada."
      }
    }
  }
};
...
const GcdsVerifyBanner$1 = /* @__PURE__ */ (0, import_stencil.proxyCustomElement)(class GcdsVerifyBanner extends import_stencil.HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    return (0, import_stencil.h)(import_stencil.Host, null, (0, import_stencil.h)("details", { class: `gcds-verify-banner ${isFixed ? "verify-banner--is-fixed" : ""}` }, (0, import_stencil.h)("summary", { class: container ? `container-${container}` : "", "aria-expanded": "false", role: "button" }, (0, import_stencil.h)("span", { class: "svg-container", innerHTML: CanadaFlag }), (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].summary.text), (0, import_stencil.h)("button", { class: "verify-banner__toggle" }, (0, import_stencil.h)("small", null, I18N[lang].summary.link), (0, import_stencil.h)("span", { class: "svg-container", innerHTML: ContentToggleArrow })))), (0, import_stencil.h)("div", { class: `verify-banner__content ${container ? `container-${container}` : ""}` }, (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].content.description)), (0, import_stencil.h)("br", null), (0, import_stencil.h)("gcds-grid", { tag: "ul", container: "lg", columns: "1fr", "columns-tablet": container === "xs" || container === "sm" ? "1fr" : "1fr 1fr" }, (0, import_stencil.h)("li", null, (0, import_stencil.h)("h4", null, I18N[lang].content.url.heading), (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].content.url.text))), (0, import_stencil.h)("li", null, (0, import_stencil.h)("h4", null, I18N[lang].content.languages.heading), (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].content.languages.text))), (0, import_stencil.h)("li", null, (0, import_stencil.h)("h4", null, I18N[lang].content.https.heading), (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].content.https.text, " ", (0, import_stencil.h)("strong", null, "https://"), "."))), (0, import_stencil.h)("li", null, (0, import_stencil.h)("h4", null, I18N[lang].content.contact.heading), (0, import_stencil.h)("p", null, (0, import_stencil.h)("small", null, I18N[lang].content.contact.text)))))));
  }
  get el() {
    return this;
  }
  static get style() {
    return GcdsVerifyBannerStyle0;
  }
...
function defineCustomElement$1() {
  ...
  components.forEach((tagName) => {
    switch (tagName) {
      ...
      case "gcds-grid":
        if (!customElements.get(tagName)) {
          (0, import_gcds_grid2.d)();
        }
        break;
    }
  });
}
const GcdsVerifyBanner2 = GcdsVerifyBanner$1;
