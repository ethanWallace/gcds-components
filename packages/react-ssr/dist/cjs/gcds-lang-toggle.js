...
var import_gcds_lang_toggle = require("./components/gcds-lang-toggle.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-lang-toggle")) {
  (0, import_gcds_lang_toggle.defineCustomElement)();
}
const customEvents = [];
const GcdsLangToggle = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-lang-toggle", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-lang-toggle", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-lang-toggle", { ...nativeProps, ref }, children);
});
