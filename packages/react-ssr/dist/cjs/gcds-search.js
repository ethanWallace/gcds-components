...
var import_gcds_search = require("./components/gcds-search.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-search")) {
  (0, import_gcds_search.defineCustomElement)();
}
const customEvents = ["gcdsInput", "gcdsChange", "gcdsFocus", "gcdsBlur", "gcdsSubmit"];
const GcdsSearch = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-search", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-search", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-search", { ...nativeProps, ref }, children);
});
