...
__export(gcds_nav_link_exports, {
  GcdsNavLink: () => GcdsNavLink
});
module.exports = __toCommonJS(gcds_nav_link_exports);
var import_react = __toESM(require("react"));
var import_gcds_nav_link = require("./components/gcds-nav-link.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-nav-link")) {
  (0, import_gcds_nav_link.defineCustomElement)();
}
const customEvents = ["gcdsClick", "gcdsFocus", "gcdsBlur"];
const GcdsNavLink = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-nav-link", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-nav-link", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-nav-link", { ...nativeProps, ref }, children);
});
