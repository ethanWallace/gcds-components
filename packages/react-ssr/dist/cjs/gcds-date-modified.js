...
__export(gcds_date_modified_exports, {
  GcdsDateModified: () => GcdsDateModified
});
module.exports = __toCommonJS(gcds_date_modified_exports);
var import_react = __toESM(require("react"));
var import_gcds_date_modified = require("./components/gcds-date-modified.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-date-modified")) {
  (0, import_gcds_date_modified.defineCustomElement)();
}
const customEvents = [];
const GcdsDateModified = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-date-modified", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-date-modified", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-date-modified", { ...nativeProps, ref }, children);
});
