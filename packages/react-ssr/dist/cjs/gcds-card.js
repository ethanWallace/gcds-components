...
var import_gcds_card = require("./components/gcds-card.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-card")) {
  (0, import_gcds_card.defineCustomElement)();
}
const customEvents = ["gcdsFocus", "gcdsBlur", "gcdsClick"];
const GcdsCard = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-card", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-card", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-card", { ...nativeProps, ref }, children);
});
