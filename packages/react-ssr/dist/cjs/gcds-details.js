...
__export(gcds_details_exports, {
  GcdsDetails: () => GcdsDetails
});
module.exports = __toCommonJS(gcds_details_exports);
var import_react = __toESM(require("react"));
var import_gcds_details = require("./components/gcds-details.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-details")) {
  (0, import_gcds_details.defineCustomElement)();
}
const customEvents = ["gcdsFocus", "gcdsBlur", "gcdsClick"];
const GcdsDetails = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-details", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-details", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-details", { ...nativeProps, ref }, children);
});
