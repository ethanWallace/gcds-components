...
__export(gcds_checkbox_exports, {
  GcdsCheckbox: () => GcdsCheckbox
});
module.exports = __toCommonJS(gcds_checkbox_exports);
var import_react = __toESM(require("react"));
var import_gcds_checkbox = require("./components/gcds-checkbox.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-checkbox")) {
  (0, import_gcds_checkbox.defineCustomElement)();
}
const customEvents = ["gcdsClick", "gcdsFocus", "gcdsBlur", "gcdsChange", "gcdsError", "gcdsValid"];
const GcdsCheckbox = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-checkbox", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-checkbox", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-checkbox", { ...nativeProps, ref }, children);
});
