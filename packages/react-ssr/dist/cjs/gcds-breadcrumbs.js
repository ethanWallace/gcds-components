...
__export(gcds_breadcrumbs_exports, {
  GcdsBreadcrumbs: () => GcdsBreadcrumbs
});
module.exports = __toCommonJS(gcds_breadcrumbs_exports);
var import_react = __toESM(require("react"));
var import_gcds_breadcrumbs = require("./components/gcds-breadcrumbs.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-breadcrumbs")) {
  (0, import_gcds_breadcrumbs.defineCustomElement)();
}
const customEvents = [];
const GcdsBreadcrumbs = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-breadcrumbs", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-breadcrumbs", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-breadcrumbs", { ...nativeProps, ref }, children);
});
