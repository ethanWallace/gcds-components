...
var import_gcds_breadcrumbs_item = require("./components/gcds-breadcrumbs-item.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-breadcrumbs-item")) {
  (0, import_gcds_breadcrumbs_item.defineCustomElement)();
}
const customEvents = [];
const GcdsBreadcrumbsItem = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-breadcrumbs-item", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-breadcrumbs-item", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-breadcrumbs-item", { ...nativeProps, ref }, children);
});
