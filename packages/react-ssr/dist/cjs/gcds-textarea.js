...
__export(gcds_textarea_exports, {
  GcdsTextarea: () => GcdsTextarea
});
module.exports = __toCommonJS(gcds_textarea_exports);
var import_react = __toESM(require("react"));
var import_gcds_textarea = require("./components/gcds-textarea.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-textarea")) {
  (0, import_gcds_textarea.defineCustomElement)();
}
const customEvents = ["gcdsFocus", "gcdsBlur", "gcdsChange", "gcdsInput", "gcdsError", "gcdsValid"];
const GcdsTextarea = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-textarea", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-textarea", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-textarea", { ...nativeProps, ref }, children);
});
