...
var import_gcds_nav_group = require("./components/gcds-nav-group.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-nav-group")) {
  (0, import_gcds_nav_group.defineCustomElement)();
}
const customEvents = ["gcdsClick", "gcdsFocus", "gcdsBlur"];
const GcdsNavGroup = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-nav-group", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-nav-group", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-nav-group", { ...nativeProps, ref }, children);
});
