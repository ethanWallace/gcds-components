...
__export(gcds_stepper_exports, {
  GcdsStepper: () => GcdsStepper
});
module.exports = __toCommonJS(gcds_stepper_exports);
var import_react = __toESM(require("react"));
var import_gcds_stepper = require("./components/gcds-stepper.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-stepper")) {
  (0, import_gcds_stepper.defineCustomElement)();
}
const customEvents = [];
const GcdsStepper = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-stepper", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-stepper", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-stepper", { ...nativeProps, ref }, children);
});
