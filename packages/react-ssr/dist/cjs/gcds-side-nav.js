...
__export(gcds_side_nav_exports, {
  GcdsSideNav: () => GcdsSideNav
});
module.exports = __toCommonJS(gcds_side_nav_exports);
var import_react = __toESM(require("react"));
var import_gcds_side_nav = require("./components/gcds-side-nav.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-side-nav")) {
  (0, import_gcds_side_nav.defineCustomElement)();
}
const customEvents = [];
const GcdsSideNav = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-side-nav", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-side-nav", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-side-nav", { ...nativeProps, ref }, children);
});
