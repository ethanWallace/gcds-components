...
var import_gcds_container = require("./components/gcds-container.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-container")) {
  (0, import_gcds_container.defineCustomElement)();
}
const customEvents = [];
const GcdsContainer = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-container", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-container", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-container", { ...nativeProps, ref }, children);
});
