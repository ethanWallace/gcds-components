...
__export(gcds_file_uploader_exports, {
  GcdsFileUploader: () => GcdsFileUploader
});
module.exports = __toCommonJS(gcds_file_uploader_exports);
var import_react = __toESM(require("react"));
var import_gcds_file_uploader = require("./components/gcds-file-uploader.js");
...
if (typeof customElements !== "undefined" && !customElements.get("gcds-file-uploader")) {
  (0, import_gcds_file_uploader.defineCustomElement)();
}
const customEvents = ["gcdsFocus", "gcdsBlur", "gcdsChange", "gcdsInput", "gcdsRemoveFile", "gcdsError", "gcdsValid"];
const GcdsFileUploader = import_react.default.forwardRef(({ children = [], ...props }, ref) => {
  let nativeProps = (0, import_native_props.toNativeProps)((0, import_utils.omitEventCallbacks)(customEvents, props));
  nativeProps = (0, import_utils.gcdsAttributeGenerator)("gcds-file-uploader", nativeProps);
  if (typeof window !== "undefined") {
    ...
    return import_react.default.createElement("gcds-file-uploader", { ...nativeProps, ref: innerRef }, children);
  }
  return import_react.default.createElement("gcds-file-uploader", { ...nativeProps, ref }, children);
});
